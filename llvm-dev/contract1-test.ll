...
@const_data10 = constant [2 x i8] c"\00\02"
...
%l0_overflow_check = icmp ugt i64 %l0_2, 32704
...
%l1_overflow_check = icmp ugt i64 %l1_2, 32704
...
%l2_overflow_check = icmp ugt i64 %l2_2, 32704
...
%l5_overflow_check = icmp ugt i64 %l5_2, 32704
...
%l9_overflow_check = icmp ugt i64 %l9_1, 32704
...
%l10_overflow_check = icmp ugt i64 %l10_2, 32704
...
%l10_4 = bitcast [2 x i8]* @const_data10 to i8*
tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(32) %l10_3, i8* noundef nonnull align 1 dereferenceable(32) %l10_4, i64 2, i1 false)
%l10_5 = getelementptr i8, i8* %l10_3, i32 2
tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(32) %l10_5, i8* noundef nonnull align 1 dereferenceable(32) %zero32_ptr, i64 30, i1 false)
...
%l11_overflow_check = icmp ugt i64 %l11_1, 32704
...
%l13_overflow_check = icmp ugt i64 %l13_2, 32704
...
%l15_overflow_check = icmp ugt i64 %l15_2, 32704
...
; OP 16 (pc: 62): SWAP1
%l16_gas1 = load i64, i64* %stack_gasleft_ptr, align 8
%l16_gas2 = icmp ult i64 %l16_gas1, 3
...
l16_gaserr:
  ...
  br label %error_return
l16_gasok:
%l16_gas4 = add i64 %l16_gas1, -3
store i64 %l16_gas4, i64* %stack_gasleft_ptr, align 1
%l16_1 = load i64, i64* %stack_position_ptr, align 8
%l16_underflow_check = icmp ult i64 %l16_1, 64
br i1 %l16_underflow_check, label %l16_err_underflow, label %l16_ok
l16_err_underflow:
  store i64 62, i64* %pc_ptr
  store i32 -10, i32* %exitcode_ptr
  br label %error_return
