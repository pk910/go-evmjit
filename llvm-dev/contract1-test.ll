...
@const_data1 = constant [32 x i8] c"\01\02\05\04\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\01\16\14\01"
...
; OP 1: PUSH32 0114160101010101010101010101010101010101010101010101010104050201
...
%l5_2 = alloca [32 x i8], align 16
%l5_3 = getelementptr inbounds i8, i8* %stack_addr, i64 %l5_1
%l5_4 = getelementptr inbounds i8, i8* %l5_3, i64 -32
%l5_5 = shl nsw i32 1, 5
%l5_6 = sext i32 %l5_5 to i64
%l5_7 = sub nsw i64 0, %l5_6
%l5_8 = getelementptr inbounds i8, i8* %l5_4, i64 %l5_7
%l5_9 = getelementptr inbounds [32 x i8], [32 x i8]* %l5_2, i64 0, i64 0
call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %l5_9, i8* noundef nonnull align 1 dereferenceable(32) %l5_4, i64 32, i1 false)
tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(32) %l5_4, i8* noundef nonnull align 1 dereferenceable(32) %l5_8, i64 32, i1 false)
call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(32) %l5_8, i8* noundef nonnull align 16 dereferenceable(32) %l5_9, i64 32, i1 false)

; OP 6: SHL
%l6_1 = load i64, i64* %stack_position_ptr, align 8
%l6_2 = getelementptr inbounds i8, i8* %stack_addr, i64 %l6_1
%l6_shiftptr = getelementptr inbounds i8, i8* %l6_2, i64 -32
%l6_valptr = getelementptr inbounds i8, i8* %l6_shiftptr, i64 -32
%l6_shiftptr2 = bitcast i8* %l6_shiftptr to i256*
%l6_valptr2 = bitcast i8* %l6_valptr to i256*
%l6_shift = load i256, i256* %l6_shiftptr2, align 1
%l6_value = load i256, i256* %l6_valptr2, align 1
%l6_shift_check = icmp uge i256 %l6_shift, 256
br i1 %l6_shift_check, label %l6_shift_large, label %l6_shift_ok
l6_shift_large:
  br label %l6_store_res
l6_shift_ok:
  %l6_shifted_val = shl i256 %l6_value, %l6_shift
  br label %l6_store_res
l6_store_res:
%l6_final_res = phi i256 [ 0, %l6_shift_large ], [ %l6_shifted_val, %l6_shift_ok ]
store i256 %l6_final_res, i256* %l6_valptr2, align 1
