...
{{- if .StackCheck }}
%l{{ .Id }}_underflow_check = icmp ult i64 %l{{ .Id }}_1, {{ mul .SwapIndex 32 }}
...
%l{{ .Id }}_3 = getelementptr inbounds i8, i8* %l{{ .Id }}_2, i64 -{{ mul .SwapIndex 32 }}
%l{{ .Id }}_4 = bitcast i8* %l{{ .Id }}_3 to i256*
%l{{ .Id }}_res0 = load i256, i256* %l{{ .Id }}_4, align 1
store i256 {{ .StackRef0 }}, i256* %l{{ .Id }}_4, align 1
{{- end }}
{{ end }}
